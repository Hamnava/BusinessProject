...
namespace BusinessProject.DataModelLayer.Migrations
{
    ...
    [Migration("20210730123920_mig-AdminstrativeForm")]
    partial class migAdminstrativeForm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.AdminstrativeForm", b =>
                {
                    b.Property<int>("AdminstrativeFormId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("AdminstrativeFormContent")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AdminstrativeFormTitle")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("AdminstrativeFormType")
                        .HasColumnType("bit");

                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("AdminstrativeFormId");

                    b.HasIndex("UserId");

                    b.ToTable("AdminstrativeForms");
                });

            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.Contract", b =>
                {
            ...
            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.Letter", b =>
                {
                    ...
                    b.Property<DateTime>("LetterCreatDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<bool>("replayDateStatus")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.RolePattern", b =>
                {
                    ...
                    b.Property<string>("RolePatternDesc")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("RolePatterns");
                });

            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.RolePatternDetails", b =>
                {
            ...
            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.Letter", b =>
                {
                    b.HasOne("BusinessProject.DataModelLayer.Entities.SystemUsers", "Users")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("BusinessProject.DataModelLayer.Entities.RolePatternDetails", b =>
                {
                    b.HasOne("BusinessProject.DataModelLayer.Entities.SystemRoles", "Roles")
                        .WithMany()
                        .HasForeignKey("RoleId");

                    b.HasOne("BusinessProject.DataModelLayer.Entities.RolePattern", "RolePattern")
                        .WithMany()
